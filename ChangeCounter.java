/* **********Documentation***********
 * Name			: Agha_Khizar
 * Class		: Object-Orientated Programming
 * Assignment	: Homework_9
 * Description	: This program implements Java GUI features to input the number of 
 * each type of coin a user has in their possession and then compute and display the 
 * total dollar and cents value of Quarter, Dime, Nickel, Penny, Half-dollar and
 * Dollar coins.
 * 
 */
  ...
  // Application Launcher
   ...
   public static void main(String[] args) {
       EventQueue.invokeLater(new Runnable() {
           public void run() {
               try {
                   ChangeCounter frame = new ChangeCounter();
   ...
   private class SwingAction extends AbstractAction {
       ...
       public void actionPerformed(ActionEvent e) {
           ...
           try {
               if (Integer.parseInt(txtQuarter.getText().trim()) < 0 
            		   || Integer.parseInt(txtDime.getText().trim()) < 0
                   ...
                   JOptionPane.showMessageDialog(null, "Invalid Entry! You can not enter negative value");
               } else {
                   ...
                   String output = "Total Change Value: $" + finalDollars + " and " + cents +"¢.";
                   textOut.setText(output);

               }
           } catch (NumberFormatException e1) {
               JOptionPane.showMessageDialog(null, "Invalid Entry! You can only enter a valid number");
           }
       }
   }
}